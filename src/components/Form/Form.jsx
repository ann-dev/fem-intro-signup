      ...
      <div className="form__content">
        <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
          <div className="form__item">
            <Input
              className={
                errors.name ? 'input__field input-error' : 'input__field'
              }
              name="name"
          ...
          <div className="form__item">
            <Input
              className={
                errors.surname ? 'input__field input-error' : 'input__field'
              }
              name="surname"
          ...
          <div className="form__item">
            <Input
              className={
                errors.email ? 'input__field input-error' : 'input__field'
              }
              name="email"
              type="email"
